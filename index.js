...
*/
 ...
 /* code here */return `This is a ${inventory[id-1].car_make} ${inventory[id-1].car_model}`
}
...
*/
function sortCarInventory(/* code here */carArray) {
  /* code here */ 
return carArray.sort((a, b) => (a.car_model >= b.car_model) ? 1 : -1);
}
